...
const LinkButton = ({ location, children, ...props }) => {
    return (
        <a
            ...
            {...props}
        >
            <div className="text-xs 2xs:text-base xs:text-lg tablet-xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold px-[4vw] md:px-[3vw] lg:px-8 pt-1.5 pb-1 group-hover:text-black">
                {children}
            </div>
        </a>
    );
